...
imageprintpath      = "bletters/alltrainletters/" 
contextpath         = "bletters/alltraincontext100/"
...
for Atype in range(5):
    imagecollectedpath  = "cwords/" + trianval  + str(Atype) + "/"
    
    filestxt            = "cwords/" + trianval  + str(Atype)+".txt"
    counttxt            = "cwords/" + trianval  + str(Atype)+".count"
    
    filestxt_train      = "cwords/" + "train_" + trianval  + str(Atype)+".txt"
    filestxt_test       = "cwords/" + "test_"  +  trianval  + str(Atype)+".txt"
    
    
    linuxpath           = "C:\Users\nour.laban\source\repos\darknet\out\build\x64-Debug\exper3\words\store\val0"
